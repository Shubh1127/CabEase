...
const ConfirmRide = (props) => {
  return (
    <div>
      ...
      <button className="w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg " onClick={()=>{props.setVehicleFound(true) ; props.setConfirmRidePanel(false)}}>Confirm Ride</button>
      </div>
    </div>
  )
}
